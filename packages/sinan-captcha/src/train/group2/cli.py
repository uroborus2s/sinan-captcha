...
from train.group2.service import build_group2_training_job, execute_group2_training_job
from train.prelabel import Group2PrelabelRequest, build_group2_prelabel_plan, run_group2_prelabel
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=False,
        help="optional; defaults to <repo>/work_home/runs/group2",
    )
    ...
    parser.add_argument(
        "--from-run",
        default=None,
        help="optional; defaults model to <repo>/work_home/runs/group2/<from-run>/weights/best.pt",
    )
    parser.add_argument(
        "--resume",
        action="store_true",
        help="resume the current run from <repo>/work_home/runs/group2/<name>/weights/last.pt",
    )
