...
from modeltest.service import ModelTestRequest, build_model_test_jobs, run_model_test
...
def build_parser() -> argparse.ArgumentParser:
    ...
    group1_parser.add_argument(
        ...
        type=Path,
        required=False,
        help="optional; defaults to <repo>/work_home/datasets/group1/<dataset-version>/splits/val.jsonl",
    )
    group1_parser.add_argument(
        "--project",
        type=Path,
        required=False,
        help="optional; defaults to <repo>/work_home/reports/group1",
    )
    ...
    group2_parser.add_argument(
        ...
        type=Path,
        required=False,
        help="optional; defaults to <repo>/work_home/datasets/group2/<dataset-version>/dataset.json",
    )
    ...
    group2_parser.add_argument(
        ...
        type=Path,
        required=False,
        help="optional; defaults to <repo>/work_home/datasets/group2/<dataset-version>/splits/val.jsonl",
    )
    group2_parser.add_argument(
        "--project",
        type=Path,
        required=False,
        help="optional; defaults to <repo>/work_home/reports/group2",
    )
    ...
    group2_parser.add_argument(
        ...
        type=Path,
        required=False,
        help="optional; defaults to <repo>/work_home/reports/group2/test_<train-name>",
    )
