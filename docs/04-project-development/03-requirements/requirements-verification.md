...
- 校验人：Codex
- 备注：已复核 `group1` 新设计口径、solver 输入兼容增量需求与背景素材扩充增量需求：正式路线保持实例匹配求解，并新增多输入形态与全格式解码兼容、背景素材扩充与正式合并能力；一级产品仍为统一验证码求解包/库
- PRD REQ 数：16
- 分析 REQ 数：16
- NFR 数：10
...
- PRD 中的需求：REQ-001、REQ-002、REQ-003、REQ-004、REQ-005、REQ-006、REQ-007、REQ-008、REQ-009、REQ-010、REQ-011、REQ-012、REQ-013、REQ-014、REQ-015、REQ-016
- 需求分析中的需求：REQ-001、REQ-002、REQ-003、REQ-004、REQ-005、REQ-006、REQ-007、REQ-008、REQ-009、REQ-010、REQ-011、REQ-012、REQ-013、REQ-014、REQ-015、REQ-016
