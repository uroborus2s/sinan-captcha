...
from core.train.group1.dataset import Group1DatasetConfig, resolve_group1_path
...
def _object_identity(value: Any) -> str:
    ...
    if isinstance(raw_class_id, int) and isinstance(raw_class, str):
        return f"{raw_class_id}:{raw_class}"
    return ""
