...
DEFAULT_GROUP1_QUERY_DIR = Path("materials/validation/group1/query")
DEFAULT_GROUP1_OUTPUT_ROOT = Path("materials/incoming")
...
DEFAULT_GROUP1_CACHE_DIR = Path(".cache/materials/group1-query-audit")
