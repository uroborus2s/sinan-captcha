...
COMMANDS: list[CommandHandler] = [
    ...
    (("materials", "audit-group1-query"), "core.materials.query_audit_cli"),
...
def _usage() -> str:
    return "\n".join(
        [
            ...
            "  materials audit-group1-query  Audit query images with local Ollama and update the group1 backlog.",
            ...
            "  uv run sinan materials audit-group1-query --model qwen2.5vl:7b",
            ...
            "  uv run sinan train group1 --dataset-version v1 --name g1_scene --component scene-detector",
