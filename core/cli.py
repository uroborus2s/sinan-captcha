...
def _usage() -> str:
    return "\n".join(
        [
            ...
            "  predict group1|group2         Run task-specific predict with default model/source/project paths.",
            "  test group1|group2            Run task-specific predict + validation and export a beginner-friendly Chinese report.",
