...
- 当前画像：图形验证码专项模型设计画像
- 预设：custom
- 技术栈：Python, PyTorch, Ultralytics YOLO（group1）, Windows, CUDA, X-AnyLabeling/CVAT
...
- 使用 JSONL 作为标签主事实源；`group1` YOLO 标签和 `group2` paired split 清单都只是派生产物。
