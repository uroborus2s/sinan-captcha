...
from repo_tools.repo_solver_export import (
    ExportedOnnxInfo,
...
class Group2SolverAssetExportTests(unittest.TestCase):
    def test_export_group2_solver_assets_writes_manifest_metadata_and_report(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("repo_tools.repo_solver_export._export_group2_onnx_from_checkpoint") as export_mock:
    ...
    def test_export_solver_assets_writes_group1_onnx_assets_matcher_metadata_and_report(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with (
                patch("repo_tools.repo_solver_export._export_yolo_onnx_from_checkpoint") as yolo_export,
                patch("repo_tools.repo_solver_export._export_icon_embedder_onnx_from_checkpoint") as embedder_export,
                patch("repo_tools.repo_solver_export._export_group2_onnx_from_checkpoint") as group2_export,
            ):
